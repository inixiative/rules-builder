...
import { Condition, FieldKind, Operator, DateOperator, ArrayOperator, SourceOption, SourceValues, FieldMap, Bridge, LensNarrowing, RuleTarget, Lens, ValueShape, RuleValue, DateExpr } from '@inixiative/json-rules';
...
declare const normalizeGroups: (cond: Condition) => Condition;
...
type Templated<T> = T extends string | number | boolean | null | undefined | Date | RegExp ? T : T extends readonly (infer U)[] ? Templated<U>[] : T extends object ? {
 ...
 *  `Condition` again. */
type FacetCondition = Templated<Condition>;
/**
...
declare const variableSlots: (template: FacetCondition) => VariableSlot[];
...
declare const presetSeed: (facet: Facet) => Condition;
/**
 ...
 */
declare const lensScopeSurface: (lensOrNarrowing: Lens | LensNarrowing, opts?: LensScopeSurfaceOptions) => LensScope;
/** Memoized hook form of {@link lensScopeSurface}. */
declare const useLensScopeSurface: (lensOrNarrowing: Lens | LensNarrowing, opts?: LensScopeSurfaceOptions) => LensScope;
...
export { validateDecoration as $, lensScopeSurface as A, type BuilderField as B, lensValuePicker as C, type Decoration as D, matchFacet as E, type Facet as F, modelDecor as G, modelFacets as H, normalizeGroups as I, presetSeed as J, relabelRelations as K, type LensLoopOption as L, removeNode as M, resolve as N, runSources as O, scopedDecoration as P, scopedFacetId as Q, type RulePath as R, type SurfaceOptions as S, selectorsApply as T, setNode as U, type Variable as V, stampFacetIds as W, unwrapCompound as X, useFacetFields as Y, useLensScopeSurface as Z, useLensValuePicker as _, type RuleBuilderSource as a, valueShapeForOperator as a0, variableSlots as a1, whereConditions as a2, wrapInCompound as a3, writeSelectorClause as a4, type Decor as b, type FacetCondition as c, type LensScope as d, type LensScopeSurfaceOptions as e, type LensValueOption as f, type LensValuePickerOptions as g, type ResolveOptions as h, type RulePathSegment as i, type SourceRows as j, type VariableSlot as k, addRule as l, asGroupRoot as m, branchFields as n, consumedTopFields as o, decorationSurfaceOptions as p, describeFacets as q, describeModelFields as r, facetBranchScope as s, facetElementLeaf as t, facetId as u, getNode as v, groupSiblings as w, isPreset as x, leadingIdentityCount as y, leadingWhereCount as z };
