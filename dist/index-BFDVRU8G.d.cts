...
declare const variableSlots: (template: Condition) => VariableSlot[];
...
export { whereConditions as $, matchFacet as A, type BuilderField as B, modelDecor as C, type Decoration as D, modelFacets as E, type Facet as F, presetSeed as G, relabelRelations as H, removeNode as I, resolve as J, runSources as K, type LensLoopOption as L, scopedDecoration as M, scopedFacetId as N, selectorsApply as O, setNode as P, stampFacetIds as Q, type RulePath as R, type SurfaceOptions as S, unwrapCompound as T, useFacetFields as U, type Variable as V, useLensScopeSurface as W, useLensValuePicker as X, validateDecoration as Y, valueShapeForOperator as Z, variableSlots as _, type RuleBuilderSource as a, wrapInCompound as a0, writeSelectorClause as a1, type Decor as b, type LensScope as c, type LensScopeSurfaceOptions as d, type LensValueOption as e, type LensValuePickerOptions as f, type ResolveOptions as g, type RulePathSegment as h, type SourceRows as i, type VariableSlot as j, addRule as k, branchFields as l, consumedTopFields as m, decorationSurfaceOptions as n, describeFacets as o, describeModelFields as p, facetBranchScope as q, facetElementLeaf as r, facetId as s, getNode as t, groupSiblings as u, isPreset as v, leadingIdentityCount as w, leadingWhereCount as x, lensScopeSurface as y, lensValuePicker as z };
